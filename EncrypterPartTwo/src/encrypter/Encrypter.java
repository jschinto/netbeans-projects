        ...
        actionListener = new ActionListener(){//the action listener that actually runs the program
            public void actionPerformed(ActionEvent actionEvent){
                if(actionEvent.getSource() == view.encrypt){//determines what called the listener
                    view.output.setText(model.encrypt(view.encryptData.getText(),view.encryptKey.getText(),view.credit.getText(),view.social.getText(),view.enPass.getText()));
                }
                else if(actionEvent.getSource() == view.decrypt){
                    view.output.setText(model.decrypt(view.decryptData.getText(),view.decryptKey.getText(),view.dePass.getText()));
                }
            }
        };
